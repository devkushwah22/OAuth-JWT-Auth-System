    ...
    try {
      ...
      if (!user) {
        ...
        user = await UserModel.create({
          googleId: profile.id,            // Add this to store Google's ID
          displayName: profile.displayName, // Add display name from Google
          image: profile._json.picture,     // Add profile image if available
