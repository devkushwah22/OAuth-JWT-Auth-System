...
class UserController {
  ...
  static verifyEmail = async (req, res) => {
    ...
    /**
     * THIS IS ONLY FOR TESTING PURPOSES TO BYPASS EMAIL VERIFICATION IN DEVELOPMENT
     */
  ...
  static userLogout = async (req, res) => {
    try {
      ...
      // Check if refresh token exists in DB before updating
      const tokenExists = await UserRefreshTokenModel.findOne({ token: refreshToken });
